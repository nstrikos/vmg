...
#include "..\dynamic_mode_compatible\dynamic_mode_compatible.h"
...
BEGIN_MESSAGE_MAP(CTestAppDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
    ON_BN_CLICKED(ID_SHOW_MAGNIFIER, &CTestAppDlg::OnBnClickedShowMagnifier)
    ON_BN_CLICKED(ID_HIDE_MAGNIFIER, &CTestAppDlg::OnBnClickedHideMagnifier)
END_MESSAGE_MAP()
...
void CTestAppDlg::OnBnClickedShowMagnifier()
{
    TPluginData pluginData;
    ZeroMemory(&pluginData, sizeof(pluginData));
    Cardinal result = Initialize(pluginData);
    Cardinal test = result;
}

void CTestAppDlg::OnBnClickedHideMagnifier()
{
    Finalize();
}
